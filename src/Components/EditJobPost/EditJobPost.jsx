...
const EditJobPost = () => {
    ...
    const { id } = useParams();
     ...
     const {_id, Experience, Experience_level, Job_Description, Location, Responsibility, Salary, Working, company, company_website, position, post_Date, qualification, time} = update;
